...
class GoogleSignin {
    ...
    currentUserAsync() {
        return new Promise((resolve, reject) => {
            const sucessCb = NativeAppEventEmitter.addListener('RNGoogleSignInSilentSuccess', (user) => {
                this._user = user;
                this._removeListeners(sucessCb, errorCb);
                resolve(user);
            });

            const errorCb = NativeAppEventEmitter.addListener('RNGoogleSignInSilentError', () => {
                this._removeListeners(sucessCb, errorCb);
                resolve(null);
            });
